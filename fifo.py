...
# Converter cada linha em um número inteiro e remover quebras de linha
...
# Remover os valores que já estão nos quadros
...
for i in range(len(lista)):
    ...
    if lista[i][0] not in [q[0] for q in lista_quadro_atual]:
        ...
        #se a pagina já estiver no quadro, não faz nada
        continue

print("Faltam quadros:", falta_quadro)
